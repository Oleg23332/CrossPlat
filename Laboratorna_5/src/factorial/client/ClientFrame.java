...
public class ClientFrame extends JFrame {
    ...
    private void countResult() throws IOException, ClassNotFoundException{
        try{
            String classFile = "E:/2_Course/Крос платформне програмування/CrossPlat/Week1/Particle1/Laboratorna_5/out/production/Laboratorna_5/factorial/client/Factorial.class";
